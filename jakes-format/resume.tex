  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Reduced dynamic-object-induced map corruption by designing deep learning perception modules for obstacle detection in crowded and unstructured environments.}
      \resumeItemListEnd
...
\section{Key Open-Source Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Achieved state-of-the-art registration accuracy with 10$\times$ lower latency than prior ICP-based methods by redesigning the correspondence search pipeline; adopted as backbone for multi-session LiDAR SLAM.}
          \resumeItemListEnd
      \resumeProjectHeading
          {\href{https://github.com/MIT-SPARK/VGGT-SLAM}{\textbf{VGGT-SLAM}} \githubstars{882} $|$ \emph{Dense RGB SLAM}}{NeurIPS 2025}
          \resumeItemListStart
            \resumeItem{Enabled production-grade dense 3D RGB mapping by optimizing trajectory estimation on the SL(4) manifold, achieving globally consistent real-time reconstruction.}
          \resumeItemListEnd
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Segmented drivable ground from 3D LiDAR at $>$100\,Hz with $<$1\% false-positive rate, deployed in AV and mobile robotics production pipelines across 5+ platforms.}
          \resumeItemListEnd
      \resumeProjectHeading
          {\href{https://github.com/LimHyungTae/ERASOR}{\textbf{ERASOR}} \githubstars{494} $|$ \emph{Static Map Building}}{IEEE RA-L 2021}
          \resumeItemListStart
            \resumeItem{Removed dynamic objects from LiDAR maps with ${\sim}$94\% precision, enabling high-fidelity static map building for long-term autonomous navigation.}
          \resumeItemListEnd
      % ---- PLACEHOLDER: add industry/work project below ----
      % \resumeProjectHeading
      %     {\textbf{[Project Name]} $|$ \emph{[Category]}}{[Company / Year]}
      %     \resumeItemListStart
